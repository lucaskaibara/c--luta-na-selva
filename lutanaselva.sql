...
--
-- Host: localhost    Database: lutanaselva
-- ------------------------------------------------------
...
CREATE TABLE `tempos` (
  ...
  `nomeJogador1` varchar(255) DEFAULT NULL,
  `nomeJogador2` varchar(255) DEFAULT NULL,
  `jogadorGanhador` int(11) DEFAULT NULL,
...
-- Dump completed on 2018-09-23 17:09:13
